...
public class MapControllerTests
{
    ...
    private static readonly MapObject _mapController = new MapObject();
    ...
    {
        var result = _mapController.GetMap(15,37.57240563371417,-83.71679868454393,null,null).Result;
